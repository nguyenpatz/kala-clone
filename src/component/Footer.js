	...
	return (
		<div className="footer">
			<div className="container flex justify-between">
				<div className="footer-logo col1 flex flex-column">
					<div>
						<img src={logo} alt="" />
					</div>
					<div>
				...
				<div className="footer-info col2 flex flex-column">
					<div>
						<h2>Thông tin</h2>
					</div>
				...
				<div className="footer-app col12">
